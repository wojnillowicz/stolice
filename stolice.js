...
var europeCapitals = {Albania:'Tirana', Andora:'Andorra', Austria: 'Vienna', Belarus:'Minsk', Belgium:'Brussels', BosniaHerzegovina:'Sarajevo', Bulgaria:'Sofia', Croatia:'Zagreb', Cyprus: 'Nicosia', Czechia:'Prague', Denmark:'Copenhagen', Estonia:'Tallinn', Finland: 'Helsinki', France: 'Paris', Georgia: 'Tbilisi', Germany: 'Berlin', Greece: 'Athens', Hungary:'Budapest', Iceland:'Reykjavik', Ireland: 'Dublin', Italy:'Rome', Kosovo:'Pristina', Latvia: 'Riga',
